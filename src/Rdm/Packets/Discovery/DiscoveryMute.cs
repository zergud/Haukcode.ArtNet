...
{
    public class Request() : RdmRequestPacket(RdmCommands.Discovery, RdmParameters.DiscoveryMute);

    public class Reply() : RdmResponsePacket(RdmCommands.DiscoveryResponse, RdmParameters.DiscoveryMute)
    {
        /// <summary>
